            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-center align-items-center flex-column">
                        ...
                        <h3 class="mt-3 mb-1" id="nama-admin"><?= $data['admin_name']; ?></h3>
                        <p class="text-small">Administrator</p>
                        <a href="<?= base_url('admin/logout'); ?>" id="btn-logout" class="btn btn-danger">Logout</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <form action="#" id="form-profile" method="get">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="admin_name" id="admin_name" class="form-control" value="<?= $data['admin_name']; ?>" disabled>
                        </div>
                        <div class="form-group">
                            <label for="email" class="form-label">Email</label>
                            <input type="text" name="admin_email" id="admin_email" class="form-control" value="<?= $data['admin_email']; ?>" disabled>
                        </div>
                        <div class="form-group">
                            <label for="email" class="form-label">Password</label>
                            <input type="password" name="admin_password" id="admin-password" class="form-control" value="<?= $data['admin_password']; ?>" disabled>
                        </div>
                        <div class="form-group">
                            <div class="d-flex">
...
<script>
    ...
    btnSimpan.addEventListener('click', function() {
        ...
        $.ajax({
            url: "<?= base_url('api/admin/akun/save'); ?>",
            method: "POST",
            cache: false,
            processData: false,
            contentType: false,
            ...
            success: function(res) {
                ...
                if (res.code == 200) {
                    $('#nama-admin').html(dataProfile.get('admin_name'));
                    Toastify({
